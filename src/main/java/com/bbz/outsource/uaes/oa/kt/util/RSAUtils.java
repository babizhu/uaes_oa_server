package com.bbz.outsource.uaes.oa.kt.util;
...
public final class RSAUtils{
    ...
    public static void main( String[] args ) throws Exception{
        System.out.println(RSAKey.PUBLIC_KEY);
        try {

            final byte[] bytes = RSAUtils.encryptByPublicKey( "abcd".getBytes(), RSAKey.PUBLIC_KEY );
...
//            RSAUtils.
            System.out.println( new String( RSAUtils.decryptByPrivateKey( bytes,RSAKey.PRIVATE_KEY ) ));
